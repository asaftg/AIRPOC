 ...
 *
 * Vendored verbatim from recorder/tap (protocol v1) — see recorder/docs/TAP.md.
 * The detection daemon uses the READER side to drain airpoc.eo_y10 and the
 * PUBLISHER side to expose airpoc.det_wire for the recorder.
 *
