...
/* the daemon's ten live controls; the GUI sends them namespaced as radar_<key>= */
static const char *RADAR_KEYS[] = { "eps", "minpts", "speed", "snrmin", "fov", "elmax",
                                    "doppler", "confirm", "coast", "park" };
